   ...
   public class StockManager
    {
        ...
        public List<Stock> StockReports(int? categoryId, int? productId, DateTime sdate, DateTime eDate)
        {
            return _stockRepository.StockReports(categoryId, productId, sdate, eDate);
        }
    }
}
